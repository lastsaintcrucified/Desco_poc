...
@Component({
  selector: "app-set-things",
  templateUrl: "./set-things.component.html",
  styleUrls: ["./set-things.component.scss"],
})
export class SetThingsComponent implements OnInit {
  editModal: any;
  ...
  constructor(
    private tableService: SetThingsService,
